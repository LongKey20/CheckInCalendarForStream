...
This project includes audio files located in the `audio/` directory. These assets are sourced from [Pixabay](https://pixabay.com) and are subject to the **Pixabay Content License**.
...
本專案之 `audio/` 資料夾內包含源自 [Pixabay](https://pixabay.com) 的音效素材，其版權與授權遵循 **Pixabay Content License**。

* **禁止獨立散佈**：這些音效檔案僅供本應用程式執行功能使用。根據 Pixabay 服務條款，**嚴禁將此資料夾內的音效單獨擷取、重新分發、轉售或挪作他用**。
